                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tangki_awal" id="tangki_awal" class="form-control" value="<?php echo set_value('tangki_awal'); ?>">
                                <small class="text-warning"><?php echo form_error('tangki_awal'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="tangki_isi">Tangki Isi Ulang</label>
                                <input type="number" name="tangki_isi" id="tangki_isi" class="form-control" value="<?php echo set_value('tangki_isi'); ?>">
                                <small class="text-warning"><?php echo form_error('tangki_isi'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="tangki_akhir">Tangki Akhir</label>
                                <input type="number" name="tangki_akhir" id="tangki_akhir" class="form-control" value="<?php echo set_value('tangki_akhir'); ?>">
