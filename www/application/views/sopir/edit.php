                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $sopir['nama']; ?>">
                                <small class="text-warning"><?php echo form_error('nama'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="notelp">No Telphone</label>
                                <input type="text" name="notelp" id="notelp" class="form-control" value="<?php echo $sopir['notelp']; ?>">
                                <small class="text-warning"><?php echo form_error('notelp'); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat sopir</label>
                                <textarea name="alamat" id="alamat" class="form-control" cols="20" rows="4"><?php echo $sopir['alamat'] ; ?></textarea>
